...
const Curso = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-secundary-color to-primary-color w-full h-auto font-montserrat min-h-screen">
      <div className="w-full h-auto shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 w-full h-auto">
          ...
          <div className="bg-white p-6 pl-20 md:col-span-3">
            ...
            <button className="text-blue-500 mt-4 hover:underline">Mostrar más</button>
          </div>

          {/* Lo que aprenderás */}
          <div className="bg-white p-6 md:col-span-2">
            <div>
              <h2 className="text-2xl font-bold mb-4 border-b border-secundary-color">Lo que aprenderás</h2>
              <ul className="list-disc list-inside text-lg">
                ...
                <li>Practicar tus habilidades con más de 50 ejercicios y desafíos de código con soluciones incluidas.</li>
              </ul>
            </div>

            {/* Profesor del curso */}
            <div className="mt-6 w-auto">
              <h2 className="text-2xl font-bold mb-4 border-b border-secundary-color">Profesor de este Curso</h2>
              <div className="flex items-center text-black p-4 rounded-lg space-x-4">
                
                {/* Foto del profesor */}
                <div className="w-12 h-12 rounded-full overflow-hidden">
                  <img src={avatar} alt="Foto del profesor" className="w-full h-full object-cover" />
                </div>
            ...
            {/* Apto para */}
            <div className="mt-6">
              <h2 className="text-2xl font-bold mb-4 border-b border-secundary-color">¿Qué conocimientos previos necesitas?</h2>
              <ul className="list-disc list-inside text-lg">
      ...
      <ContentPlans title="Únete para obtener acceso completo" text="y desbloquea todo tu potencial."/>
    </section>
  );
}

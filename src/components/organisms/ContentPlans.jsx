...
const ContentPlans = ({title , text}) => {
  return (
    <section className="bg-gradient-to-b from-secundary-color to-primary-color w-full h-auto font-montserrat pb-24">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h3 className="text-5xl text-extra-color font-montserrat  font-bold text-center py-8">{title} </h3>

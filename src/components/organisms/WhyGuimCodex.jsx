...
const WhyGuimCodex = () => {
  return (
    <div className="bg-secundary-color w-full h-auto ">
        <h3 className="text-center text-3xl sm:text-4xl md:text-5xl font-montserrat py-8 font-bold text-light-color">¿Por qué Academia GuimCodeX?</h3>

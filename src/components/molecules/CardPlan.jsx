const CardPlan = ({planType, type, price,numStudent , saving }) => {
    ...
    const styles = {
        basic: {
        borderColor: 'border-extra-color',
        bgColor: 'bg-secundary-color',
        textColor: 'text-light-color',
        buttonBg: 'bg-extra-color',
        buttonText: 'text-secundary-color',
        borderBottom: 'border-gray-200',
        hoverBG:'hover:bg-btn-color-primary',
        hoverText:'hover:text-secundary-color'
        },
        family: {
        borderColor: 'border-transparent',
        bgColor: 'bg-btn-color-primary',
        textColor: 'text-secundary-color',
        buttonBg: 'bg-btn-color-secondary',
        buttonText: 'text-light-color',
